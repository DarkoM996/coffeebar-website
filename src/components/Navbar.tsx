...
const Navbar = () => {
  ...
  return (
    <nav className="border-b border-stone-200 bg-primary_backgroundLighterColor-50/80 backdrop-filter backdrop-blur-3xl sticky top-0 left-0 right-0 z-50 text-black">
