...
const Navbar = () => {
  ...
  return (
    <nav className="border-b border-stone-200 fixed top-0 left-0 bg-transparent z-20 w-full text-black">
      <div className="max-w-screen-3xl mx-auto w-full h-20 flex justify-between items-center px-6 py-4 lg:px-28">
        ...
        <ul
          ...
          className={
            !nav
              ? "hidden"
              : "absolute top-0 left-0 w-full h-screen flex flex-col justify-center items-center gap-8 lg:gap-16 bg-primary_backgroundDarkerColor-950 text-primary_backgroundLighterColor-100 z-10"
          }
        >
          <Link
            to="/"
